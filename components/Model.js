...
export default function Model() {
    ...
    useGSAP(()=>{
        ...
        gsap.to('#heading', {y: 0, opacity: 1, scrollTrigger: '#heading'})
    })

    return (
        <section ref={sourceRef} className="common-padding">
            <div className="screen-max-width">
                ...
                <div className="flex flex-col items-center mt-5">
                    <div className="w-full h-[75vh] md:h-[90vh] overflow-hidden relative">
                        ...
                        <Canvas className="w-full h-full" style={{position: 'fixed', top: 0, bottom: 0, left: 0, right: 0, overflow: 'hidden' }} eventSource={sourceRef}>
                            <View.Port/>
                        </Canvas>
                    </div>
